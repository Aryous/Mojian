...
| **中约束** | `.Codex/rules/` | 自动注入 Agent 上下文 | 理论上可以 |
...
Agent 定义见 `.Codex/agents/`。

---

## 链接协议

系统元素之间通过三个协议连接（完整定义见 `.Codex/rules/protocols.md`）：
...
产品决策 → requirements.md，技术决策 → tech-decisions.md，行为修正 → .Codex/rules/。
